        ...
        <div class="panel panel-flat">
          <div class="panel-body">
              ...
              <table align="center">
                ...
                <td align="center"><b style="font-size: 14px;">LAPORAN DATA LOG ACTIVITY USER<br>
                  ...
                  <table class="table table-striped text-center"  width="200%" border="1px"  >
                    <thead style=" ; font-weight: bold; font-color: white">
                      <tr >
                        ...
                        <th class="main" style="border: 1px solid black;">ID User</th>
                        <th class="main" style="border: 1px solid black;">Activity</th>
                        <th class="main"style="border: 1px solid black;">Hari/Tgl</th>
                        <th class="main" style="border: 1px solid black;">Jam</th>
                      </tr>
                    </thead>
                    <tbody class="main">
                       <?php $i = 1;
                        $rows = mysqli_query($koneksi, "SELECT * FROM log_akses")
                        ?>
