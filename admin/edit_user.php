...
if( isset($_POST["ubah"]) ) {
        ...
        if( ubahuser($_POST) > 0 ) {
            echo "
                <script>
                    document.location.href = 'user.php?update=1';
                </script>
            ";
        } else {
            echo "
                <script>
                    document.location.href = 'user.php?gagal=1';
                </script>
            ";
        }
    } 
                ...
                <div class="card-body">
                    ...
                    <input type="hidden" class="form-control" id="id" name="id" value="<?= $data['id'] ;?> ">
                          ...
                          <div class="col-md-6 mb-3">
                           ...
                           <div class="col-md-6 mb-3">
                            <h6>Kode User</h6>
                            <input type="text" class="form-control" name="kode" id="kode" value="<?= $data['kd_user'] ;?>" readonly="">
                          </div>
                        
                        <!-- password disini -->
                            <!-- <input type="hidden" class="form-control" name="pass" id="pass" value="<?= $data['password'] ;?>"> -->

                        <!-- Email disini -->
                            <input type="hidden" class="form-control" name="email" id="email" value="<?= $data['email'] ;?>" readonly="">
                          ...
                          <div class="col-md-4 mb-3">
                            ...
                            <img src="img/<?= $data['foto']; ?>" class="img-thumbnail" width="80px" height="80px" align="float-right">

                      </div>

                                 <button class="btn btn-success float-right ml-2" type="submit" name="ubah">Edit data</button>
                                 <a class="btn btn-danger float-right " href="user.php">Batal</a>
                    </div>
                  </form>
                </div>
                <!-- /.card-body -->
