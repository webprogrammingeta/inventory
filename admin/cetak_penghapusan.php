        ...
        <div class="panel panel-flat">
          <div class="panel-body">
              ...
              <table align="center">
                ...
                <td align="center"><b style="font-size: 14px;">LAPORAN DATA PENGHAPUSAN BARANG INVENTARIS<br>
              ...
              <hr style="border: 1px solid black; ">
               ...
               <div class="table-responsive">
                  <table class="table table-striped text-center"  width="200%" border="1px"  >
                    ...
                    <tbody class="main">
                       <?php $i = 1;
                        $rows = mysqli_query($koneksi, "SELECT * FROM tbl_penghapusan ORDER BY id DESC")
                        ?>
