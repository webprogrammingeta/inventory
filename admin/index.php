  <?php 
    ...
    // CHARTS COLUMN
          ...
          // CHARTS PIECHARTS
          $querykondisi = "SELECT kondisi_barang, count(*) AS number FROM tbl_barang GROUP BY kondisi_barang";
          $result = mysqli_query($koneksi,$querykondisi);
  ?>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="card-header py-3">
            <h6 class="text-muted"><i class="fas fa-chart-pie mr-2 text-info"></i> Grafik Barang Berdasarkan Kategori</h6>
          <!-- Charts -->
          ...
          <div class="card-header py-3">
            ...
            <h6 class="text-muted"><i class="fas fa-chart-pie mr-2 text-info"></i> Grafik Barang Berdasarkan Kondisi</h6>
          <!-- Charts -->
      ...
      function drawChart() {
        ...
        var data = google.visualization.arrayToDataTable([
          ...
          <?php while ($row = mysqli_fetch_array($result)) {
            echo "['".$row["kondisi_barang"]."', ".$row['number']."],";
          } 
          ?>
        ]);
