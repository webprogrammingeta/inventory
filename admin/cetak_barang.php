          ...
          <div class="panel-body">
              ...
              <table align="center">
                ...
                <td align="center" style="font-size: 20px;"><b> LAPORAN DATA BARANG <br>
                 <CENTER> GMIT KALVARI MAUMERE TAHUN <?= $id ?> - <?= date(
     "Y"
 ) ?></CENTER>
                 </td>
               ...
               <div class="table-responsive">
                  <table class="table table-striped text-center"  width="200%" border="1px"  >
                    ...
                    <tbody class="main">
                       ...
                       $rows = mysqli_query(
                           $koneksi,
                           "SELECT * FROM tbl_barang ORDER BY id DESC"
                       );
                       ?>
              ...
              ?>
                      <tr class="mt-2">
                        ...
                        <td style="border: 1px solid black;"><img src="<?= $baseoperator ?>/barang/<?= $row[
    "foto"
] ?>" width =100 title="<?= $row["foto"] ?>"></td>
                        <td style="border: 1px solid black;" width =127><?= $row[
                            "kd_barang"
                        ] ?></td>
                        <td style="border: 1px solid black;" width =140><?= $row[
                            "nama_barang"
                        ] ?> </td>
                        <td style="border: 1px solid black;" width =40><?= $row[
                            "keterangan"
                        ] ?> </td>
                        <td style="border: 1px solid black;" width =20><?= $row[
                            "jumlah_satuan"
                        ] ?> <?= $row["satuan"] ?> </td>
                        <td style="border: 1px solid black;" width =40>Rp.<?= number_format(
                            $row["harga_satuan"],
                            0,
                            ",",
                            "."
                        ...
                        <td style="border: 1px solid black;"><?= $row[
                            "asal_perolehan"
                        ] ?></td>
                        <td style="border: 1px solid black;"><?= date_format(
                            $tglpem,
                            "d/m/Y"
                        ) ?></td>
                        <td style="border: 1px solid black;"><?= date_format(
              ...
              <div style="float:right; color: black;">
                ...
                <br><br><br><br><br><br>
                <p style="font-size: 12px;"><b><i>Pencetak : <?= $_SESSION[
                    "nama_lengkap"
                ] ?></i></b></p>
