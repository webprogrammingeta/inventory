    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <a href="ganti_password.php?id=<?= $_SESSION['id'] ?>" class="btn btn-app-sm text-sm text-dark float-right m-0">
			...
			<img class="profile-user-img img-fluid img-circle" src="img/<?= $_SESSION['foto']; ?>" alt="User profile picture">
      ...
      <a class="float-right text-secondary"><?= $_SESSION['tempat_lahir']; ?>, <?= date_format($date,'d/m/Y');?></a>
        ...
        <?php if (isset($_GET['update'])) : ?>
          <div class="flash-ubah bg-primary" data-flashubah="<?= $_GET['update']; ?>"></div>
        <?php endif; ?>
