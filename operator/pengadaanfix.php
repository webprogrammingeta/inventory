...
<?php
  ...
  $kode = ("U");
  $qry = mysqli_query($koneksi,"SELECT max(id_usulan) AS kodebaru FROM tbl_usulan_pengadaan WHERE id_usulan LIKE '$kode%'");
  $dt = mysqli_fetch_array($qry);
  $ambil = $dt['kodebaru'];
  $no = substr($ambil, 1, 3);
  $urut = $no + 1;
  $idusulan = $kode . sprintf("%03s", $urut);
?>
...
<?php 
     if(isset($_POST['submit'])){
        ...
        $c = $_POST['namabarang'];
        $d = $_POST['hrgbrg'];
        $query = "INSERT INTO `tbl_usulan_pengadaan` (`id`,`id_usulan`,`kd_barang`,`nama_barang`,`harga`)VALUES(NULL,'$a','$b','$c','$d')";
          ...
          <div class="col-12">
            <div class="card card-outline card-dark bg-dark">
              <div class="card-header bg-warning">
                <h4 class="card-title">Cari Data Barang</h4>
            ...
            <div class="row">
              ...
              <div class="col-md-4 mb-3">
               ...
               <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control" name="hrgbrg" id="hrgbrg" value="" required="">
              </div>
            </div>
      ...
      const flashdata = $('.flash-data').data('flashdata')
        if (flashdata) {
          Swal.fire({
            ...
            window.location.assign("http://localhost/kalvarisarpas/operator/pengadaan.php");
            });
        }
