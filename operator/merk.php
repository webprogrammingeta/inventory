...
<?php 
     if(isset($_POST['tambah'])){
        $nama = $_POST['nama'];
        $query = "INSERT INTO `tbl_merk` (`id`,`nama_merk`)VALUES(NULL,'$nama')";
        if(performQuery($query)){
            echo "<script>document.location='merk.php'</script>";
            // alert('Data merk berhasil disimpan !');
        }else{
          ...
          <div class="col-12">
            <div class="card card-outline card-dark bg-dark">
              <div class="card-header bg-warning">
                <h2 class="card-title">Tabel Data Merk</h2>
                ...
                <div class="modal-dialog">
                  <div class="modal-content text-dark">
                    <div class="modal-header bg-info text-white">
                      <h3 class="modal-title" id="exampleModalLabel">Input Merk</h3>
                    ...
                    <div class="modal-body">
                          <div class="col-md mb-3">
                            <h6>Nama Merk</h6>
                            <input type="text" class="form-control"  name="nama" id="nama" placeholder="Nama Merk" autofocus="true" required="">
                          </div>
                    </div>
              ...
              <div class="card-body ">
                <table id="example1" class="table table-bordered table-striped  table-hover text-center table-secondary text-dark">
                  ...
                  <tbody>
                    ...
                    $rows = mysqli_query($koneksi, "SELECT * FROM tbl_merk ORDER BY id ASC")
                        ?>
              <?php foreach ($rows as $row) : ?>
                  <tr>
                   ...
                   <td><?= $row['nama_merk'] ?></td>
                   <td>
                       <a href="edit_merk.php?id=<?= $row['id'] ?>" class="btn  text-primary btn-app-sm ">
                          <i class="fas fa-edit"></i>
                        </a>  
                       <a href="hapus_merk.php?id=<?= $row['id']; ?>" class="btn text-danger btn-app-sm delete" id="delete<?= $row['id']; ?>">
...
<!-- Hapus -->
  <script type="text/javascript">
      $('#delete<?= $row['id']; ?>').on('click',function(e){
        e.preventDefault();
      ...
      if (flashdata) {
        Swal.fire({
          ...
          window.location.assign("http://localhost:8080/sarpas/operator/merk.php");
          });
      }
