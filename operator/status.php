...
<?php 
     if(isset($_POST['tambah'])){
        $nama = $_POST['nama'];
        $kode = $_POST['kode'];
        $query = "INSERT INTO `tbl_status` (`id`,`kd_status`,`nama_status`)VALUES('','$kode','$nama')";
          ...
          <div class="col-12">
            <div class="card card-outline card-dark bg-dark">
              <div class="card-header bg-warning">
                <h2 class="card-title">Tabel Data status</h2>
                ...
                <div class="modal-dialog">
                  <div class="modal-content text-dark">
                    <div class="modal-header bg-info text-white">
                      <h3 class="modal-title" id="exampleModalLabel">Input status</h3>
                    ...
                    <div class="modal-body">
                          ...
                          <div class="col-md mb-3">
                            <h6>Nama status</h6>
                            <input type="text" class="form-control"  name="nama" id="nama" placeholder="Nama status" autofocus="true" required="">
                          </div>
                    </div>
              ...
              <div class="card-body ">
                <table id="example1" class="table table-bordered table-striped  table-hover text-center table-secondary text-dark">
                  ...
                  <tbody>
                    ...
                    $rows = mysqli_query($koneksi, "SELECT * FROM tbl_status ORDER BY id ASC")
                        ?>
              <?php foreach ($rows as $row) : ?>
                  <tr>
                   ...
                   <!-- <td><?= $row['kd_status'] ?></td> -->
                   <td >
                       <a href="edit_status.php?id=<?= $row['id'] ?>" class="btn text-primary btn-app-sm">
                          <i class="fas fa-edit"></i>
                        </a>  
                       <a href="hapus_status.php?id=<?= $row['id']; ?>" class="btn text-danger btn-app-sm" id="delete">
            ...
            $("#simpan").click(function(){
                ...
                if ( nama == '' ) {
                    Swal.fire({
                        ...
                        type: "error",
                        icon: "error",
                        text: "Nama status tidak boleh kosong !",
                    ...
                    Swal.fire({
                        ...
                        type: "error",
                        icon: "error",
                        text: "Kode status tidak boleh kosong !",
                        showConfirmButton: false,
                        timer: 1400
                    });
                }else{
      ...
      if (flashdata) {
        Swal.fire({
           ...
           timer: 1200
            ...
            window.location.assign("<?= $baseoperator;?>/status.php");
          });
      }
