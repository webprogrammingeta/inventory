        ...
        <div class="panel panel-flat">
          <div class="panel-body">
              ...
              <table align="center">
                ...
                <td align="center"><b style="font-size: 14px;">LAPORAN DATA USULAN PEMINJAMAN BARANG INVENTARIS<br>
              ...
              <hr style="border: 1px solid black; ">
               ...
               <div class="table-responsive">
                  <table class="table table-striped text-center"  width="200%" border="1px">
                    ...
                    <tbody class="main">
                       <?php $i = 1;
                        $rows = mysqli_query($koneksi, "SELECT * FROM tbl_pengajuan_peminjaman ORDER BY id DESC")
                        ?>
                      ...
                      <tr class="mt-2">
                        <td><?= $i++; ?></td>
                           <td width="200"><?= $row['id_pengajuan'] ?></td>
