...
<?php 
     if(isset($_POST['tambah'])){
        $nama = $_POST['nama'];
        $kode = $_POST['kode'];
        $query = "INSERT INTO `tbl_kategori` (`id`,`nama_kategori`,`kode_kategori` )VALUES(NULL,'$nama','$kode')";
          ...
          <div class="col-12">
            <div class="card card-outline card-dark bg-dark">
              <div class="card-header bg-warning">
                <h2 class="card-title">Tabel Data Kategori</h2>
                ...
                <div class="modal-dialog">
                  <div class="modal-content text-dark">
                    <div class="modal-header bg-info text-white">
                      <h3 class="modal-title" id="exampleModalLabel">Input Kategori</h3>
                    ...
                    <div class="modal-body">
                          <div class="col-md mb-3">
                            <h6>Nama Kategori</h6>
                            <input type="text" class="form-control"  name="nama" id="nama" placeholder="Nama Kategori" autofocus="true" required="">
                          </div>

                          <div class="col-md mb-3">
                            <h6>Kode Kategori</h6>
                            <input type="text" class="form-control" name="kode" id="kode" placeholder="Kode Kategori" required="">
                          </div>
                    </div>
              ...
              <div class="card-body ">
                <table id="example1" class="table table-bordered table-striped  table-hover text-center table-secondary text-dark">
                  ...
                  <tbody>
                    ...
                    $rows = mysqli_query($koneksi, "SELECT * FROM tbl_kategori ORDER BY id ASC")
                        ?>
              <?php foreach ($rows as $row) : ?>
                  <tr>
                   <td><?= $i++; ?></td>
                   <td><?= $row['nama_kategori'] ?></td>
                   <td class=""><button class=" btn border-dark"><?= $row['kode_kategori'] ?></button></td>
                   <td >
                       <a href="edit_kategori.php?id=<?= $row['id'] ?>" class="btn  text-primary btn-app-sm ">
                          <i class="fas fa-edit"></i>
                        </a>  
                       <a href="hapus_kategori.php?id=<?= $row['id']; ?>" class="btn text-danger btn-app-sm" id="delete">
  ...
  <script type="text/javascript">
      ...
      if (flashdata) {
        Swal.fire({
          ...
          window.location.assign("<?=$baseoperator;?>/kategori.php");
          });
      }
