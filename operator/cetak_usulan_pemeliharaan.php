        ...
        <div class="panel panel-flat">
          <div class="panel-body">
              ...
              <table align="center">
                ...
                <td align="center"><b style="font-size: 14px;">LAPORAN DATA USULAN PEMELIHARAAN BARANG INVENTARIS<br>
                  ...
                  <table class="table table-striped text-center"  width="200%" border="1px"  >
                    <thead style=" ; font-weight: bold; font-color: white">
                      <tr>
                        ...
                        <th class="main" style="border: 1px solid black;">Photo</th>
                        ...
                        <th class="main" style="border: 1px solid black;">Biaya</th>
                        <th class="main" style="border: 1px solid black;">Waktu</th>
                    ...
                    <tbody class="main">
                      ...
                      <tr class="mt-2">
                        <td><?= $i++; ?></td>
                           ...
                           <td width="200"><?= $row['id_pemeliharaan'] ?></td>
                           <td><?= $row['kd_barang'] ?></td>
